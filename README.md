...
- **Ogni 6 ore** (01:00, 07:00, 13:00, 19:00 UTC): aggiornamento prezzi/portafoglio
- **07:00 e 19:00 UTC**: anche l'analisi tecnica approfondita completa (indicatori,
  Elliott, macro, multi-timeframe) — più lenta e costosa, quindi solo 2 volte al giorno

## Cosa manca ancora (prossimi passi)

- Scheda **Aggiornamenti** (feed + community + airdrop) — le funzioni di base
  esistono già nel codice (`scrape_daily_feed_headlines`, `call_claude_for_analysis`)
  ma non sono ancora collegate all'interfaccia
- Schede **Report Settimanali** e **Mensili** con countdown
- **Avvisi email** per eventi rilevanti
